...
namespace Lyra\LyraIndia\Block\System\Config\Form\Field;
...
class Webhook extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    {
        $webhookUrl = $this->store->getBaseUrl() . 'lyraindia/payment/webhook';
        $value = "You may login to <a target=\"_blank\" href=\"https://www.lyra.com/in/\">Lyra India Website</a> to update your Webhook URL to:<br><br>"
